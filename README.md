...
```javascript
indexOf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-index-of@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-index-of@v0.3.0-umd/browser.js"></script>
```
